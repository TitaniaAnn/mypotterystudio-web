...
<section class="section">
    <div class="container" style="max-width: 760px;">
        ...
        <p style="color: var(--stone); margin-bottom: 40px;">Last updated: May 2, 2026</p>
        ...
        <div class="prose">
            ...
            <ul>
                ...
                <li><strong>Imported data:</strong> pieces, sales, clients, or materials you bring in from a CSV or Excel file you select. Imported data is processed and stored locally, the same as data entered manually.</li>
            ...
            <ul>
                ...
                <li><strong>File picker:</strong> Access to a file you explicitly select for backup restore or data import. The file is read once at the time you select it; nothing is uploaded.</li>
            </ul>
            ...
            <ul>
                ...
                <li><strong>Import control:</strong> Imported files are read only when you select them. An import can be undone in full from the Import data screen — every row added by that import is removed.</li>
            </ul>
